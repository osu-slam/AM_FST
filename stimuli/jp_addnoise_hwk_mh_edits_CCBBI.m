function outputfiles = jp_addnoise_hwk_mh_edits_CCBBI(soundfiles, cfg)
...
% 01/24/20 -- Missing a dependency, added to bottom of script. -- MJH
...
if ~isempty(cfg.outdir) && ~(exist(cfg.outdir, 'file') == 7)
    mkdir(cfg.outdir);
end
