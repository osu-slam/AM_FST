...
% Timing
p.runsMax = 6; % New design has more stimuli and longer runs
p.events = 28; % Events per block, needs updating. 
p.sentences  = 14; % how many sentence stimuli per block?
p.structures = 12; % how many sentence structures?
